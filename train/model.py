...
class ConfirmingModel(nn.Module):
    ...
    def __init__(self, n_cnn_layers, n_class, n_feats, stride=2, dropout=0.1):
        ...
        self.cnn_layers.append(CNN(in_channels=1, out_channels=128, kernel=3, stride=1, n_feats=n_feats))
        self.cnn_layers.append(CNN(in_channels=128, out_channels=64, kernel=3, stride=1, n_feats=n_feats))
        self.cnn_layers.append(CNN(in_channels=64, out_channels=64, kernel=3, stride=1, n_feats=n_feats))
